  ...
  return (
    <div className={`fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center ${isOpen ? '' : 'hidden'}`}>
      <div className="fixed bottom-10 right-4 bg-[#2b2b45] p-4 rounded-lg w-[320px] md:w-[520px] flex flex-col items-end">
        ...
        <p className="text-[12px] md:text-[14px] mb-4 md:mb-8">You can interact and browse the collection of designs that have been made by swiping the image to the right or left using a mouse on a PC or touching the screen on a smartphone/tablet. You can also select the tabs for more content.</p>
