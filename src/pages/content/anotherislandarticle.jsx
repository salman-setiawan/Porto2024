    ...
    <div className="bg-[#111111] min-h-screen text-[#d3d3d3]">
      ...
      <div className="flex justify-center max-h-screen pt-20 pb-8">
        <div className="flex flex-col items-center space-y-8 px-4 md:w-[720px] overflow-y-auto">
          ...
          />
          <img src="/assets/anotherisland/content1.png" alt="" className="" />
          <Paragraph 
            title='Identify Need.'
          ...
          <div className="flex flex-col space-y-2.5">
            <img src="/assets/anotherisland/content2.jpg" alt="" className="w-full" />
          ...
          />
          <img src="/assets/anotherisland/content3.png" alt="" className="w-full" />
          <Paragraph
          ...
          />
          <img src="/assets/anotherisland/content4.png" alt="" className="" />
          <Paragraph
          ...
          />
          <img src="/assets/anotherisland/ces1.png" alt="" className="" />
          <Paragraph 
          ...
          <Paragraph 
            ...
            desc2='The next stage is processing data from open-ended questions such as reviews and feedback from players. The results have been selected based on the similarity of opinions provided by players. Here are the findings.'
          />
          <img src="/assets/anotherisland/ces2.png" alt="" className="" />
          <Paragraph 
